...
"AccWindowMinimize" = "Minimize";
"AccWindowMaximize" = "Maximize";
"AccWindowRestore" = "Restore";
...
"AirTranslateChat" = "Translate chat";
"AirTranslateChatOff" = "Show original";
"AirTranslateMessage" = "Translate message";
"AirTranslateComposer" = "Translate typed text";
"AirTranslateError" = "Couldn't translate. Please try again.";
"AirTranslateEmpty" = "Nothing to translate";
"AirTranslatePending" = "Translating...";
"MenuTranslate" = "Translate";
"AirTranslateSource" = "From";
"AirTranslateTarget" = "To";
"AirTranslateProvider" = "Provider";
"AirTranslateAuto" = "Detect automatically";
"AirTranslateSave" = "Save";
"AirTranslateGoogle" = "Google";
"AirTranslateMyMemory" = "MyMemory";
"AirTranslateLibre" = "LibreTranslate";
"AirTranslateDeepL" = "DeepL";
"AirTranslateNoProvider" = "No translation providers are available.";
"AirProfilesTitle" = "Profiles";
"AirProfilesManage" = "Manage Profiles";
"AirProfilesAdd" = "Add Profile";
"AirProfilesSearch" = "Search profiles";
"AirProfilesEmpty" = "No profiles match your search";
"AirProfilesKindPersonal" = "Personal";
"AirProfilesKindBusiness" = "Business";
"AirProfilesKindAdmin" = "Channel Admin";
"AirProfilesRename" = "Profile name";
"AirProfilesBackup" = "Backup Profiles";
"AirProfilesBackupOne" = "Export this profile";
"AirProfilesRestore" = "Restore from backup";
"AirProfilesBackupDone_one" = "Saved {count} profile";
"AirProfilesBackupDone_other" = "Saved {count} profiles";
"AirProfilesRestoreDone_one" = "Restored {count} profile";
"AirProfilesRestoreDone_other" = "Restored {count} profiles";
"AirProfilesRestoreSkip_one" = "{count} profile is already on this device";
"AirProfilesRestoreSkip_other" = "{count} profiles are already on this device";
"AirProfilesBackupWarning" = "This file contains login keys. Keep it private and only restore it on devices you trust.";
"AirProfilesCurrent" = "Current";
"AirProfilesUnlimited" = "Add as many profiles as you need, then switch, label, or back them up.";
"AirProfilesInvalidBackup" = "This file is not a valid profile backup";
"AirProfilesSlotLimit" = "No more profile slots are available on this device";
"AirProfilesMore_one" = "{count} more profile";
"AirProfilesMore_other" = "{count} more profiles";
"AirQuickReplyTitle" = "Quick Replies";
"AirQuickReplyOpen" = "Quick replies";
"AirQuickReplySettings" = "Quick reply settings";
"AirQuickReplyHint" = "Commands you add are saved on this device.";
"AirQuickReplyShortcut" = "Command";
"AirQuickReplyContent" = "Reply";
"AirQuickReplyAdd" = "Add";
"AirQuickReplySave" = "Save";
"AirQuickReplyEmpty" = "No commands yet";
"AirQuickReplyInvalid" = "Enter a command and a reply";
"AirQuickReplyExists" = "This command already exists";
"ChatHubOpen" = "Open ChatHub";
"ChatHubTitle" = "ChatHub";
"ChatHubBackToTelegram" = "Telegram";
"ChatHubSearchPlaceholder" = "Search";
"ChatHubInbox" = "Chats";
"ChatHubInboxTab" = "Inbox";
"ChatHubPeople" = "People";
"ChatHubEmptyThread" = "Your messages";
"ChatHubEmptyThreadHint" = "Send a message or pick a chat from the left";
"ChatHubActiveNow" = "Active now";
"ChatHubWorkspaceTelegram" = "Telegram";
"ChatHubWorkspaceChatHub" = "ChatHub";
"ChatHubTelegramDesc" = "Chat, groups & channels";
"ChatHubDesc" = "All accounts in one place";
"ChatHubAllAccounts" = "All Accounts";
"ChatHubPriority" = "Priority";
"ChatHubUnread" = "Unread";
"ChatHubMentions" = "Mentions";
"ChatHubPinned" = "Pinned";
"ChatHubPrivate" = "Private";
"ChatHubGroups" = "Groups";
"ChatHubChannels" = "Channels";
"ChatHubBots" = "Bots";
"ChatHubAccounts" = "Accounts";
"ChatHubFolders" = "Folders";
"ChatHubSettings" = "ChatHub Settings";
"ChatHubShowAccountBadge" = "Show account badge";
"ChatHubShowAccountName" = "Show account name";
"ChatHubShowUnreadCount" = "Show unread count";
"ChatHubShowFolders" = "Show folders";
"ChatHubShowChannels" = "Show channels";
"ChatHubShowBots" = "Show bots";
"ChatHubCompactMode" = "Compact mode";
"ChatHubViewUnified" = "Unified";
"ChatHubViewGrouped" = "Grouped";
"ChatHubHotkey" = "Keyboard shortcut";
"ChatHubConnecting" = "Reconnecting";
"ChatHubOffline" = "Offline";
"ChatHubEmpty" = "No chats to show";
"ChatHubEmptySearch" = "No matching chats";
"ChatHubLoadAccount" = "Open this account to load chats";
"ChatHubOpenChat" = "Open";
"ChatHubMarkRead" = "Mark as read";
"ChatHubMute" = "Mute";
"ChatHubUnmute" = "Unmute";
"ChatHubPin" = "Pin";
"ChatHubUnpin" = "Unpin";
"ChatHubArchive" = "Archive";
"ChatHubPriorityAdd" = "Priority";
"ChatHubPriorityRemove" = "Remove from Priority";
"ChatHubSelectChat" = "Select a chat";
"ChatHubSelectChatHint" = "Pick a conversation to start messaging";
"ChatHubBackToList" = "Back to chats";
"ChatHubOpenInTelegram" = "Open in Telegram";
"ChatHubCachedHint" = "Showing saved messages. Switch accounts in Telegram to reply live";
"ChatHubNoMessages" = "No messages yet";
"ChatHubMessagePlaceholder" = "Message";
"ChatHubSend" = "Send";
"ChatHubPhoto" = "Photo";
"ChatHubVideo" = "Video";
"ChatHubSticker" = "Sticker";
"ChatHubFile" = "File";
"ChatHubVoice" = "Voice message";
"ChatHubAudio" = "Audio";
"ChatHubAction" = "Service message";
"ChatHubOtherMessage" = "Message";
"ChatHubMessageText" = "Message";
"DesktopUpdate" = "Update";
"DesktopUpdateBusy" = "Updating...";
"DesktopUpdateProgress" = "{percent}%";
"DesktopUpdateInstalling" = "Installing...";
"DesktopUpdateFailed" = "Could not install the update. Try again.";
"AccDesktopUpdate" = "Download and install version {version}";
"AccDesktopUpdateProgress" = "Downloading update, {percent} percent";
"AccAppSplash" = "Loading {app}";
`;export{e as default};
//# sourceMappingURL=fallback-BA75Gxaa.js.map